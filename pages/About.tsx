...
import { Award, Target, Users, Quote } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  const testimonials = [
    { name: "Alexandre G.", text: "L'ambiance est imbattable. Chaque cours est un défi et un plaisir à la fois." },
    { name: "Marie L.", text: "Les séances 100% Femmes ont changé ma vie. Je me sens plus forte que jamais." },
    { name: "Thomas B.", text: "Les coachs ici se soucient vraiment de votre technique et de votre progression." },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {trainers.map((trainer, i) => (
              <div key={i} className="group overflow-hidden rounded-xl bg-zinc-900 border border-zinc-800">
                ...
                <div className="p-6">
                  ...
                  <p className="text-zinc-500 text-xs">{trainer.bio}</p>
                </div>
              </div>
            ))}
          </div>
