...
export const TRANSLATIONS = {
  fr: {
    ...
    footer_address: '123 Fitness Street, Ville, Pays',
    footer_email: 'info@onemorefit.com',
  ...
  en: {
    ...
    about_desc: 'Empowering individuals to achieve one more rep, one more class, one more goal.',
    trainers_title: 'Our Trainers',
    testimonials_title: 'Testimonials',
    contact_info: 'Contact Information',
    footer_address: '123 Fitness Street, City, Country',
    footer_email: 'info@onemorefit.com',
    footer_phone: '+123-456-7890',
